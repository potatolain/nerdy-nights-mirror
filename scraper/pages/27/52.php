<div class="mdl-card__title"><strong>Roth</strong> posted on 
	...
	<br>
	2. In terms of graphics, what purpose do programs like Tile Layer Pro serve for the homebrewer? Most of the information that I have been able to find about this type of program relates to ROM hacking so even a broad overview would be helpful (or a link to a broad overview). Is this somewhat similar to the map editor that Sivak wrote for his games, or that Maiu posted a while back for Project P (<br clear="all"><div class="col-md-6"><div class="embed-responsive embed-responsive-16by9"><iframe width="500" height="280" frameborder="0" src="https://www.youtube.com/embed/DjYeB604a1s?list=UUGNm2vGRTPwbO0Q6u-X7MuA" allowfullscreen></iframe></div></div><br clear="all">)? It would appear that at least the latter programs would alleviate some of the need for coding each individual tile of the background (not trying to bypass that essential skill, but just looking ahead).<br>
	<br>
