...
<br>
<br>If he hasnt, or you dont want to wait, you need to clone the LoadBackground method and give it different starting points, and make additional data tables (backgroundX<img src="i/expressions/face-icon-small-smile.gif" border="0" style="display: none;"> and load each of those in 256 (or less) sized chunks.
<br>
