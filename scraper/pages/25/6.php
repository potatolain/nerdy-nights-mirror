<div class="mdl-card__title"><strong>Cthulhu32</strong> posted on 
				...
				May 28, 2009 at 11:07:54 AM 
					...
					<div class="FTQUOTE"><i>Originally posted by: <b>bunnyboy</b></i><br><br>Other than using the debugger to find the bankswitching location, all you need to know to make it a multicart is covered in previous lessons  <img src="images/blank.gif" border="0" style="display: none;" original-src="i/expressions/face-icon-small-smile.gif"></div><br><br>So all you&apos;d have to do is put a game&apos;s code/sprites in PRG/CHR banks and switch when you want to load a cart? (is this what you did for Pirate Booty?) Those hong-kong multi-carts aren&apos;t this simple are they? Like those 100-in-1s?
