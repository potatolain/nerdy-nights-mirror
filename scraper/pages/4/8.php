...
<div><br></div><div>After the initial setup you will almost entirely ignore the vblank flag. &#xA0;Instead you will use NMI.</div><div><br></div><div>Sprites go outside the visible area to cure some of confusion. &#xA0;If they are left at 0 all 64 sprites will be in the upper left corner. &#xA0;Because of the 8 sprites per scanline limit anything else you put on that top row will be invisible, possibly causing you to spend hours debugging for nothing &#xA0;<img src="images/blank.gif" border="0" style="display: none;" original-src="i/expressions/face-icon-small-smile.gif"></div>
