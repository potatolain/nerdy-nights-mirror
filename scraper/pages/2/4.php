...
Wait for week 4!  <img src="i/expressions/face-icon-small-wink.gif" border="0" style="display: none;">  On NTSC you have enough vblank time to update all 64 sprites, and about 3 rows or columns of background.  Your game should only have to update a maximum of 1 row for stuff scrolling in, then maybe another row worth for status bar and erasing step chart arrows that were hit.  Some games like Battletoads will turn the screen on late or turn it off early to get more vblank time.
<br><br>
<div class="FTQUOTE"><begin quote><i>Originally posted by: <b>dangevin</b></i>
