            ...
            <?php foreach($TUTORIAL_MANIFEST['audio'] as $idx => $item): ?>
                ...
                <div class="tutorialCard mdl-card mdl-shadow--2dp" id="audio_tutorial-<?php echo $idx; ?>">
                    ...
                    <div class="mdl-card__actions mdl-card--border">
                        ...
                        <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="javascript:doCommentToggle('audio_tutorial-<?php echo $idx; ?>__comments');">
                            Toggle Comments
                        </a>
                ...
                <div class="comments" style="display: none;" id="audio_tutorial-<?php echo $idx; ?>__comments">
                    <?php foreach (glob('scraper/pages/' . $CURR_PAGE . '/*.php') as $subIndex => $file): ?>

                        <div class="commentCard mdl-card mdl-shadow--2dp" id="audio_tutorial-<?php echo $idx . '__' . ($subIndex + 1); ?>">
